                        ...
                        <div class="p-6 bg-white border-b border-gray-200 product-table">
                            <table class="table-auto w-full text-left overflow-hidden overflow-x-auto">
                                ...
                                <tr>
                                    ...
                                    <th class="w-auto ">Partial Delivery</th>
                                ...
                                @foreach($deliveries as $delivery)
                                        <tr class=" @if(($delivery->id % 2) == 0) bg-gray-100 @endif">
                                            ...
                                            <td>@if($delivery->p_date) {{$delivery->p_date}} @else <a href="{{url('/delivery/partial/'.$delivery->id)}}" class="font-bold ">Set Partial</a>@endif</td>
                                        </tr>
                                @endforeach
                                </tbody>
                            </table>
